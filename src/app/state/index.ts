...
export const workFlowingDisableAtom = atomWithStorage('workFlowingDisable', true)
export const fpHashAtom = atomWithStorage('fpHash', "")
export const gameModeEnable = atomWithStorage('gameModeEnable', false)
...
export const showSettingsAtom = atomWithStorage('showSettings', false)
export const showNavSettingsAtom = atomWithStorage('showNavSettings', true)
...
export const promptFlowDesc = atomWithStorage('promptFlowDesc', "")
export const promptFlowTips = atomWithStorage('promptFlowTips', [])

...
const resources = {
  'zh': {
    translation: {
      Start: '启动',
      'Confirm whether to exit the GPTs?': '确认是否退出GPTs?',
      'Shortcut to open this app': '打开ChatDev的快捷键',
      'Confirm whether to start your GPTs?': '是否确认开启你的 GPTs？',
      Settings: '设置',
      'Startup page': '启动页面',
      'Chat style': '会话风格',
      ...
      "The GPTs has been completed. You can continue to wait for other team members to join. Click the button above to switch to chat mode and view the project overview. When all members are present, you can start the roundtable meeting and approach the corresponding team member to continue the current project discussion.":"GPTs已执行完毕，您可以继续等待其他伙伴的加入。点击上方切换按钮进入聊天模式，以查看项目概览。当所有成员都到齐后，您可以开始圆桌会议，靠近对应的伙伴继续讨论当前的项目。",
